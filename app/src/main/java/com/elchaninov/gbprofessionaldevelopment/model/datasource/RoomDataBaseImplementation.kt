...
class RoomDataBaseImplementation(private val translationDao: TranslationDao) :
    ...
    override suspend fun getTranslation(word: String): EntityTranslation =
        translationDao.getTranslation(word)

    override suspend fun updateTranslation(entityTranslation: EntityTranslation) =
        translationDao.updateTranslation(entityTranslation)
}